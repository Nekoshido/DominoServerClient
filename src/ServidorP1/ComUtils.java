...
public class ComUtils {
  ...
  public String read_string(int tamany) throws IOException
  {
    String str;
    byte bStr[] = new byte[tamany];
    char cStr[] = new char[tamany];
 
    bStr = read_bytes(tamany);
  ...
  public String read_string() throws IOException
  {
   ...
   /* Escriure un string */
  public void write_string(int tamany, String str ) throws IOException
  { 
    int numBytes, lenStr; 
    byte bStr[] = new byte[tamany];
